...
namespace {
struct qt_meta_tag_ZN10DictionaryE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10DictionaryE = QtMocHelpers::stringData(
    "Dictionary"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10DictionaryE[] = {
...
Q_CONSTINIT const QMetaObject Dictionary::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10DictionaryE.offsetsAndSizes,
    qt_meta_data_ZN10DictionaryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10DictionaryE_t,
        // Q_OBJECT / Q_GADGET
...
void *Dictionary::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10DictionaryE.stringdata0))
